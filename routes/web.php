...
Route::group(['namespace' => 'Auth', 'middleware' => ['share', 'check_maintenance', 'check_restriction']], function () {
    ...
    Route::post('/update-user-type', 'SocialiteController@updateUserType')->name('updateUserType');
    Route::post('/community', 'SocialiteController@communityPage')->name('store.community'); 
...
Route::group(['namespace' => 'Web', 'middleware' => ['check_mobile_app', 'impersonate', 'share', 'check_maintenance', 'check_restriction']], function () {
    ...
    Route::group(['prefix' => 'instructor-finder'], function () {
        Route::get('/', 'InstructorFinderController@index')->name('instructor-finder.index');
        Route::get('/wizard', 'InstructorFinderController@wizard')->name('instructor-finder.wizard');
    });
    

    Route::group(['prefix' => 'products'], function () {
        Route::get('/', 'ProductController@searchLists')->name('products.store');
