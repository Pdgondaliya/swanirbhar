                ...
                <div class="mx-lg-30 d-none d-lg-flex flex-grow-1 navbar-toggle-content " id="navbarContent">
                    ...
                    <ul class="navbar-nav mr-auto d-flex align-items-center">
                        ...
                        <li>
                            {{-- <form action="/search" method="get" class="d-inline-flex mt-5 p-5 w-100">
                                <div class="form-group d-flex align-items-center m-0 slider-search p-10 bg-white w-100">
                                    <input type="text" name="search" class="form-control border-1 mr-lg-10 w-100"
                                        placeholder="{{ trans('home.slider_search_placeholder') }}" />
                                    <button type="submit"
                                        class="btn btn-primary btn-sm rounded-pill">{{ trans('home.find') }}</button>
                                </div>
                            </form> --}}
                            <form action="/search" method="get" class="d-inline-flex mt-5 p-5 w-100">
                                <div class="bar">
                            ...
                            <div class="container d-flex justify-content-between flex-column flex-lg-row">
                                <div class="top-contact-box border-bottom d-flex flex-column flex-md-row align-items-center justify-content-center">
                                    ...
                                    <form action="/search" method="get" class="form-inline my-2 my-lg-0 navbar-search position-relative">
                                        <input class="form-control mr-5 rounded-pill" type="text" name="search" placeholder="{{ trans('navbar.search_anything') }}" aria-label="Search">
                        ...
                        <li class="nav-item mr-15">
                            <a class="nav-link" href="{{ route('instructor-finder.index') }}">Tutorhub</a>
                        </li>
                        <li class="nav-item mr-15">
                            <a class="nav-link" href="{{ route('products.store') }}">Stores</a>
                        </li>
                        <li class="nav-item mr-15">
                            <a class="nav-link" href="{{ route('forums.index') }}">Community</a>
                        </li>
                    ...
                    {{-- <!--<div class="language-select mt-1">-->
                    <!--   <div id="localItems" data-selected-country="US" data-countries="{&quot;IQ&quot;:&quot;Arabic&quot;,&quot;BD&quot;:&quot;Bangla&quot;,&quot;US&quot;:&quot;English&quot;,&quot;ES&quot;:&quot;Spanish&quot;}" class="flagstrap">-->
                    ...
                    <!--      </select>-->
                    <!--      <button type="button" data-toggle="dropdown" id="flagstrap-drop-down-fdNeh2ZH" class="btn btn-default btn-sm dropdown-toggle"><span class="flagstrap-selected-fdNeh2ZH"><i class="flagstrap-icon flagstrap-us" style="margin-right: 5px;"></i>English</span><span class="caret" style="margin-left: 5px;"></span></button>-->
                    <!--      <ul id="flagstrap-drop-down-fdNeh2ZH-list" aria-labelled-by="flagstrap-drop-down-fdNeh2ZH" class="dropdown-menu" style="height: auto; max-height: 350px; overflow-x: hidden;">-->
                    <!--         <li><a data-val="">Change Language</a></li>-->
                    <!--         <li><a data-val="IQ"><i class="flagstrap-icon flagstrap-iq" style="margin-right: 5px;"></i>Arabic</a></li>-->
                    <!--         <li><a data-val="BD"><i class="flagstrap-icon flagstrap-bd" style="margin-right: 5px;"></i>Bangla</a></li>-->
                    <!--         <li><a data-val="US"><i class="flagstrap-icon flagstrap-us" style="margin-right: 5px;"></i>English</a></li>-->
                    <!--         <li><a data-val="ES"><i class="flagstrap-icon flagstrap-es" style="margin-right: 5px;"></i>Spanish</a></li>-->
                    <!--      </ul>-->
                    <!--   </div>-->
                    <!--</div>--> --}}
                </div>
        ...
        <div class="{{ (!empty($isPanel) and $isPanel) ? 'container-fluid' : 'container' }}">
            <div class="d-flex align-items-center justify-content-between w-100">
                ...
                <div class="mx-lg-30 d-none d-lg-flex flex-grow-1 navbar-toggle-content " id="navbarContent">
                    ...
                    {{-- <div class="language-select mt-20">
                        <div id="localItems" data-selected-country="US"
                            ...
                            <button type="button" data-toggle="dropdown" id="flagstrap-drop-down-fdNeh2ZH"
                                class="btn btn-default btn-sm dropdown-toggle"><span
                                    class="flagstrap-selected-fdNeh2ZH"><i class="flagstrap-icon flagstrap-us"
                                        style="margin-right: 5px;"></i>English</span><span class="caret"
                                    style="margin-left: 5px;"></span></button>
                            <ul id="flagstrap-drop-down-fdNeh2ZH-list" aria-labelled-by="flagstrap-drop-down-fdNeh2ZH"
                                class="dropdown-menu" style="height: auto; max-height: 350px; overflow-x: hidden;">
                                <li><a data-val="">Change Language</a></li>
                                <li><a data-val="IQ"><i class="flagstrap-icon flagstrap-iq"
                                            style="margin-right: 5px;"></i>Arabic</a></li>
                                <li><a data-val="BD"><i class="flagstrap-icon flagstrap-bd"
                                            style="margin-right: 5px;"></i>Bangla</a></li>
                                <li><a data-val="US"><i class="flagstrap-icon flagstrap-us"
                                            style="margin-right: 5px;"></i>English</a></li>
                                <li><a data-val="ES"><i class="flagstrap-icon flagstrap-es"
                ...
                <div class="language-select">
                    <div id="localItems" data-selected-country="US"
                        ...
                        <ul id="flagstrap-drop-down-fdNeh2ZH-list" aria-labelled-by="flagstrap-drop-down-fdNeh2ZH"
                            ...
                            <li>
                                <a href="{{ url('/panel') }}" style="align-items: center; display: flex;">
