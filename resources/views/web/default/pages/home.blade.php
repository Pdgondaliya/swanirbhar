        ...
        <section class="slider-container  {{ $heroSection == '2' ? 'slider-hero-section2' : '' }}"
            ...
            <div class="container user-select-none">
                ...
                @else
                        ...
                        @if(!empty(getFeaturesSettings('show_google_login_button')))
                            <div class="centered-container">
                                <div class="signup-container">
                                    <h1>Explore your creativity with thousands of hands-on classes.</h1>
                                    <p>Get 7 free days of Swanirbhar</p>
                                    <div class="auth-buttons">                                     
                                        <a href="/google" target="_blank"><button class="google">Continue with Google  
                                        </button></a>                                        
                                    ...
                                    <p class="small-text">By signing up you agree to Swanirbhar's <a href="#">Terms of Service</a> and <a href="#">Privacy Policy</a>, and agree to receive marketing communications from Swanirbhar at the email address provided. This page is protected by reCAPTCHA and is subject to Google's <a href="#">Terms of Service</a> and <a href="#">Privacy Policy</a>.</p>
                                </div>
                            </div>
                        @endif
                    @endif
                    {{-- <div class="text-center slider-content">
                       <h1>{{ $heroSectionData['title'] }}</h1> 
                        <h1 class="typeJsText" data-typetext="{{ $heroSectionData['title'] }}" style="overflow: hidden; white-space: nowrap; line-height: 1.0; height: 1.0em;"></h1>
                        <div class="row h-100 align-items-center justify-content-center text-center">
                        ...
                        @if(!Auth::user())
                            ...
                            <a href="{{url('/login')}}"  class="social-login mt-20 p-10 text-center d-flex align-items-center justify-content-center ">
                            <img src="/assets/default/img/auth/default.png" class="mr-auto" alt="facebook svg"/>
                                    <span class="flex-grow-1">Login with email</span>
                            </a>
                        @endif
                            </div>
                        </div>
