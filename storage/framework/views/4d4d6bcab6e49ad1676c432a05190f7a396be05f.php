...
<div class="ai-content-generator-drawer bg-white">
    <div class="ai-content-generator-drawer-header d-flex align-items-center justify-content-between p-15">
        <div class="">
            <h5 class="font-16 font-weight-bold"><?php echo e(trans('update.ai_content_generator')); ?></h5>
            <p class="mt-5 font-12 text-gray"><?php echo e(trans('update.generate_content_using_AI_fast_and_premium')); ?></p>
        </div>
    ...
    <div class="drawer-content p-15" data-simplebar <?php if((!empty($isRtl) and $isRtl)): ?> data-simplebar-direction="rtl" <?php endif; ?>>
        ...
        <form action="/panel/ai-contents/generate" method="post">
            ...
            <div class="d-flex align-items-center p-15 rounded-sm bg-info-light border-gray300 mb-15">
                ...
                <div class="ml-5">
                    <h5 class="d-block font-weight-bold text-gray font-14"><?php echo e(trans('update.generate_content_easily')); ?></h5>
                    <p class="font-12 text-gray"><?php echo e(trans('update.select_the_content_type_you_want_and_describe_your_requirements_and_get_the_content')); ?></p>
                </div>
            </div>
            ...
            <div class="js-text-templates-field mt-20 mt-20 <?php echo e((!empty($aiSettings['activate_text_service_type']) and empty($aiSettings['activate_image_service_type'])) ? '' : 'd-none'); ?>">
                ...
                <div class="js-for-service-fields form-group d-none">
                    ...
                    <div class="invalid-feedback"></div>
                    <p class="mt-5 font-12 text-gray"><?php echo e(trans('update.describe_in_some_words_about_what_you_want')); ?></p>
                </div>
                ...
                <div class="form-group js-question-field d-none">
                    ...
                    <div class="invalid-feedback"></div>
                    <p class="mt-5 font-12 text-gray"><?php echo e(trans('update.ask_ai_what_you_want')); ?></p>
                </div>
...
<?php /**PATH /home/u195145987/domains/swanirbhar.org.in/public_html/resources/views/web/default/panel/includes/aiContent/generator.blade.php ENDPATH**/ ?>