                                        ...
                                        <?php if($order->status == "open" or $order->status == "pending_verification"): ?>
                                            ...
                                            <?php if(!empty($order->upcoming_installment)): ?>
                                                <div class="d-flex align-items-start flex-column mt-20 mr-15">
                                                    ...
                                                    <span class="stat-value"><?php echo e(dateTimeFormat((($order->upcoming_installment->deadline * 86400) + $order->created_at), 'j M Y')); ?> (<?php echo e(handlePrice($order->upcoming_installment->getPrice($itemPrice))); ?>)</span>
                                                </div>
                                            <?php endif; ?>
...
<?php echo $__env->make(getTemplate() .'.panel.layouts.panel_layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u195145987/domains/swanirbhar.org.in/public_html/resources/views/web/default/panel/financial/installments/lists.blade.php ENDPATH**/ ?>