<div class="dropdown">
    <button type="button" class="btn btn-transparent dropdown-toggle" <?php echo e((empty($unReadNotifications) or count($unReadNotifications) < 1) ? 'disabled' : ''); ?> id="navbarNotification" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false" style="margin-top: 10px;">
...
<?php /**PATH /home/u195145987/domains/swanirbhar.org.in/public_html/resources/views/web/default/includes/notification-dropdown.blade.php ENDPATH**/ ?>