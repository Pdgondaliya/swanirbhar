<div class="d-none" id="productShareModal">
    ...
    <div class="text-center">
        ...
        <p class="mt-20 font-14"><?php echo e(trans('update.share_this_product_with_others')); ?></p>
        ...
        <div class="position-relative d-flex align-items-center justify-content-between p-15 mt-15 border border-gray250 rounded-sm mt-5">
            <div class="js-product-share-link font-weight-bold px-16 text-ellipsis font-14"><?php echo e($product->getUrl()); ?></div>

            <button type="button" class="js-product-share-link-copy btn btn-primary btn-sm font-14 font-weight-500 flex-none" data-toggle="tooltip" data-placement="top" title="<?php echo e(trans('public.copy')); ?>"><?php echo e(trans('public.copy')); ?></button>
        </div>

        <div class="mt-32 mt-lg-40 row align-items-center font-14">
            <a href="<?php echo e($product->getShareLink('telegram')); ?>" target="_blank" class="col text-center">
            ...
            <a href="<?php echo e($product->getShareLink('whatsapp')); ?>" target="_blank" class="col text-center">
            ...
            <a href="<?php echo e($product->getShareLink('facebook')); ?>" target="_blank" class="col text-center">
            ...
            <a href="<?php echo e($product->getShareLink('twitter')); ?>" target="_blank" class="col text-center">
...
<?php /**PATH /home/u195145987/domains/swanirbhar.org.in/public_html/resources/views/web/default/products/includes/share_modal.blade.php ENDPATH**/ ?>